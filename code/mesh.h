...
{
    // Front
    { .m_A = 1, .m_B = 2, .m_C = 3, .m_Color = RED },
    { .m_A = 3, .m_B = 2, .m_C = 4, .m_Color = RED },

    // Right
    { .m_A = 3, .m_B = 4, .m_C = 5, .m_Color = LIGHT_GREEN },
    { .m_A = 5, .m_B = 4, .m_C = 6, .m_Color = LIGHT_GREEN },

    // Back
    { .m_A = 5, .m_B = 6, .m_C = 7, .m_Color = BLUE },
    { .m_A = 7, .m_B = 6, .m_C = 8, .m_Color = BLUE },

    // Left
    { .m_A = 7, .m_B = 8, .m_C = 1, .m_Color = YELLOW },
    { .m_A = 1, .m_B = 8, .m_C = 2, .m_Color = YELLOW },

    // Top
    { .m_A = 2, .m_B = 8, .m_C = 4, .m_Color = MAGENTA },
    { .m_A = 4, .m_B = 8, .m_C = 6, .m_Color = MAGENTA },

    // Bottom
    { .m_A = 7, .m_B = 1, .m_C = 5, .m_Color = CYAN },
    { .m_A = 5, .m_B = 1, .m_C = 3, .m_Color = CYAN },
};
